...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Elmer21',
      password: 'AjNA_kRK5HGqnZ5',
      email: 'Mary20@gmail.com',
      name: 'Lucas Green',
      mobileNo: '892-660-4525 x06034',
      role: 798,
      resetPasswordLink: {},
      loginRetryLimit: 419,
      loginReactiveTime: '2022-07-08T13:24:38.977Z',
      id: '61ee33347bf9bb14e96e4241'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Bryce56',
        'password':'E_rgvWbMEP9Bhhe',
        'email':'Nicholaus45@gmail.com',
        'name':'Jerald McDermott DVM',
        'mobileNo':'841-468-3755',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Nicholaus45@gmail.com', });

...
/**
 * @description : upsert document of ProjectRoute into the table.
 * @param {obj} req : request including data in request body.
 * @param {obj} res : response that contains upserted ProjectRoute.
 * @return {obj} : upserted of ProjectRoute. {status, message, data}
 */

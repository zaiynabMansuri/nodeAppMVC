...
/**
 * @description : upsert document of RouteRole into the table.
 * @param {obj} req : request including data in request body.
 * @param {obj} res : response that contains upserted RouteRole.
 * @return {obj} : upserted of RouteRole. {status, message, data}
 */

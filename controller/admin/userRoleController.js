...
/**
 * @description : upsert document of UserRole into the table.
 * @param {obj} req : request including data in request body.
 * @param {obj} res : response that contains upserted UserRole.
 * @return {obj} : upserted of UserRole. {status, message, data}
 */
